        ...
        <div class="container-fluid">
          ...
          <div class="be-right-navbar">
            <ul class="nav navbar-nav float-right be-user-nav">
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="assets/img/profile/defaultimg.jpg" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
